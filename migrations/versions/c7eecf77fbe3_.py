...
def upgrade():
    ...
    op.add_column('merchants', sa.Column('api_key', postgresql.UUID(as_uuid=True), nullable=False))
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('merchants', sa.Column('apiKey', postgresql.UUID(), autoincrement=False, nullable=False))
